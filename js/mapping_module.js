    ...
    groupOrder.forEach(function(cat) {
      ...
      if (isOpen) {
        rows.forEach(function(r) {
          ...
          var baseDlBtn = baseUrl ? '<a class="mp-dl-btn base" href="' + esc(baseUrl) + '" target="_blank" title="查看基线型号资料">📥</a>' : '<span class="mp-dl-btn disabled" title="暂无">—</span>';
          var distDlBtn = distUrl ? '<a class="mp-dl-btn dist" href="' + esc(distUrl) + '" target="_blank" title="查看经销型号资料">📥</a>' : '<span class="mp-dl-btn disabled" title="暂无">—</span>';
  ...
  function updateTableHeader() {
    ...
    if (showCodeColumns) {
      thead.innerHTML =
        ...
        '<th style="width:50px;text-align:center">资料</th>' +
