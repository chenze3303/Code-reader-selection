...
海康机器人读码器（Code Reader）智能选型 / 竞品对标 / 配单生成 / 产品对照 / 状态码查询 / SDK 参考 / 资料下载工具。纯前端实现，无需服务器，浏览器直接打开 `index.html` 即可使用。
...
### 6. SDK 参考（app.js 中的 page-sdk）

MvCodeReader SDK C/C# 版学习指南，支持语言切换、目录导航、暗黑模式适配。
